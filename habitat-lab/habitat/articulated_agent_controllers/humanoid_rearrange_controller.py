...
class HumanoidRearrangeController(HumanoidBaseController):
    ...
    def calculate_walk_pose(
        ...
        joint_pose, obj_transform = new_pose.joints, new_pose.root_transform #! TROVATI
        ...
        self.obj_transform_base = obj_transform_base @ rot_offset # ? quaternion rotation
        self.joint_pose = joint_pose # ? quaternion/rot6d rotation
