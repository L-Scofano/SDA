...
class RolloutStorage(Storage):
    ...
    def __init__(
        ...
        self.buffers['aux_infos'] = TensorDict()
        self.buffers['aux_infos']['dist_to_goal'] = torch.zeros(numsteps + 1,
                                                                num_envs, 1)
        self.buffers['aux_infos']['rot_dist_to_goal'] = torch.zeros(
    ...
    def insert_first_observations(self, batch, aux_infos):
        ...
        self.buffers["aux_infos"]['dist_to_goal'][0] = aux_infos[
            'dist_to_goal']
        self.buffers["aux_infos"]['rot_dist_to_goal'][0] = aux_infos[
            'rot_dist_to_goal']
