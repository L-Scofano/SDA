...
if __name__ == "__main__":
    ...
    # Assuming your image is a numpy array
    image = np.random.rand(1, 1, 240, 228)  # Your 1x1x240x228 image
    depth_image = image[0, 0]  # Remove singleton dimensions

    # Create the noise model
    noise_model = RedwoodDepthNoiseModel()

    # Apply the noise model
    noisy_depth = noise_model.apply(depth_image)

    # plot and save the noisy depth image and the original depth image
    plt.imshow(noisy_depth, cmap='gray')
